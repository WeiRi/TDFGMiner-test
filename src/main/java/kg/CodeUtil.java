...
import common.collection.FList;
import common.skeleton.model.type.ArrayType;
import common.skeleton.model.type.PrimitiveType;
...
public class CodeUtil {
    ...
    //获取所需方法对应的方法实体，如果不存在则返回null
    public MethodEntity getMethod(String qualifiedSignature){
        return repository.getMethodEntity(qualifiedSignature);
    }
    ...
    public Set<String>  getAllParentTypes(String qualifiedName){
        ...
        //System.out.println("try to get entity:"+qualifiedName);
        if (entity == null) return Set.of(qualifiedName);
        //System.out.println("we get entity:"+qualifiedName);
