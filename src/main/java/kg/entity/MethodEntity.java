...
public class MethodEntity {
    ...
    public MethodEntity(ResolvedConstructorDeclaration resolved, boolean isDeprecated, TypeEntity declareType, MethodJavadocEntity javadoc) {
        ...
        paramTypes.add(this.returnType);
        this.structVector=String.join(",",paramTypes);
        this.paramNames = String.join(",", paramNames);
        this.textVector=this.paramNames;
    ...
    public String getStructVector(){return structVector;}

    public String getTextVector(){return textVector;}
